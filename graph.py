...
class Vertex(object):
    ...
    def __init__(self, graph: "Graph", label=None, color=0):
        """
    ...
    def color_neighbours(self) -> List[int]:
        """
        :return: a list containing the colors of its neighbours
        """
        return [x.color for x in self.neighbours]
